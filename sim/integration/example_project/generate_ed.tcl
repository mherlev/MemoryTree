...
lappend arg_list "--report-file=csv:mem_if_ddr3_emif_0_example_design_example.csv"
lappend arg_list "--report-file=qip:mem_if_ddr3_emif_0_example_design_example.qip"
lappend arg_list "--output-name=mem_if_ddr3_emif_0_example_design_example"
...
lappend arg_list "--component-param=CALIBRATION_MODE=Quick"
...
lappend arg_list "--component-param=CTL_LOOK_AHEAD_DEPTH=1"
lappend arg_list "--component-param=CTL_SELF_REFRESH_EN=false"
lappend arg_list "--component-param=CTL_USR_REFRESH_EN=true"
...
lappend arg_list "--component-param=MEM_TRFC_NS=110.0"
...
lappend arg_list "--component-param=REF_CLK_FREQ=100.0"
...
lappend arg_list "--component-param=TIMING_TDQSCK=255"
...
catch { eval [concat [list exec "/data/local/altera/14.0/quartus/sopc_builder/bin/ip-generate" --component-name=alt_mem_if_ddr3_tg_ed] $arg_list] } temp
puts $temp
