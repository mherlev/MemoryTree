// mem_if_ddr3_emif_0_example_design_example_if0_s0.v

// This file was auto-generated from qsys_sequencer_110_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 14.0 200 at 2016.05.21.21:50:09

`timescale 1 ps / 1 ps
module mem_if_ddr3_emif_0_example_design_example_if0_s0 (
	...
	wire   [0:0] trk_mm_bridge_m0_burstcount;                               // trk_mm_bridge:m0_burstcount -> mm_interconnect_0:trk_mm_bridge_m0_burstcount
	wire         trk_mm_bridge_m0_waitrequest;                              // mm_interconnect_0:trk_mm_bridge_m0_waitrequest -> trk_mm_bridge:m0_waitrequest
	wire  [15:0] trk_mm_bridge_m0_address;                                  // trk_mm_bridge:m0_address -> mm_interconnect_0:trk_mm_bridge_m0_address
	wire  [31:0] trk_mm_bridge_m0_writedata;                                // trk_mm_bridge:m0_writedata -> mm_interconnect_0:trk_mm_bridge_m0_writedata
	wire         trk_mm_bridge_m0_write;                                    // trk_mm_bridge:m0_write -> mm_interconnect_0:trk_mm_bridge_m0_write
	wire         trk_mm_bridge_m0_read;                                     // trk_mm_bridge:m0_read -> mm_interconnect_0:trk_mm_bridge_m0_read
	wire  [31:0] trk_mm_bridge_m0_readdata;                                 // mm_interconnect_0:trk_mm_bridge_m0_readdata -> trk_mm_bridge:m0_readdata
	wire         trk_mm_bridge_m0_debugaccess;                              // trk_mm_bridge:m0_debugaccess -> mm_interconnect_0:trk_mm_bridge_m0_debugaccess
	wire   [3:0] trk_mm_bridge_m0_byteenable;                               // trk_mm_bridge:m0_byteenable -> mm_interconnect_0:trk_mm_bridge_m0_byteenable
	wire         trk_mm_bridge_m0_readdatavalid;                            // mm_interconnect_0:trk_mm_bridge_m0_readdatavalid -> trk_mm_bridge:m0_readdatavalid
	...
	rw_manager_ddr3 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("STRATIXV"),
		.AC_ROM_INIT_FILE_NAME                ("mem_if_ddr3_emif_0_example_design_example_if0_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("mem_if_ddr3_emif_0_example_design_example_if0_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (27648),
		.INIT_FILE        ("mem_if_ddr3_emif_0_example_design_example_if0_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	mem_if_ddr3_emif_0_example_design_example_if0_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	mem_if_ddr3_emif_0_example_design_example_if0_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
