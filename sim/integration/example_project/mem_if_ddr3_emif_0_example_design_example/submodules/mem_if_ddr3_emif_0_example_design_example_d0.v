// mem_if_ddr3_emif_0_example_design_example_d0.v
...
`timescale 1 ps / 1 ps
module mem_if_ddr3_emif_0_example_design_example_d0 #(
		parameter DEVICE_FAMILY                          = "Stratix V",
		parameter TG_AVL_DATA_WIDTH                      = 512,
		parameter TG_AVL_ADDR_WIDTH                      = 30,
		parameter TG_AVL_WORD_ADDR_WIDTH                 = 24,
		parameter TG_AVL_SIZE_WIDTH                      = 1,
		parameter TG_AVL_BE_WIDTH                        = 64,
		parameter DRIVER_SIGNATURE                       = 1431634060,
		...
		output wire [29:0]  avl_addr,        //          .address
		output wire         avl_size,        //          .burstcount
		output wire [511:0] avl_wdata,       //          .writedata
		input  wire [511:0] avl_rdata,       //          .readdata
		output wire         avl_write_req,   //          .write
		output wire         avl_read_req,    //          .read
		input  wire         avl_rdata_valid, //          .readdatavalid
		output wire [63:0]  avl_be,          //          .byteenable
	...
	generate
		...
		if (DRIVER_SIGNATURE != 1431634060)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
