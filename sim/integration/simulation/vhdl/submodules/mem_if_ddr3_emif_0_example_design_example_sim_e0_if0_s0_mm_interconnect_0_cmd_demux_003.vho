...
--synthesis_resources = 
 ...
 ENTITY  mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_mm_interconnect_0_cmd_demux_003 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src0_data	:	OUT  STD_LOGIC_VECTOR (107 DOWNTO 0);
		 ...
		 src1_data	:	OUT  STD_LOGIC_VECTOR (107 DOWNTO 0);
		 ...
		 src2_data	:	OUT  STD_LOGIC_VECTOR (107 DOWNTO 0);
		 ...
		 src3_data	:	OUT  STD_LOGIC_VECTOR (107 DOWNTO 0);
		 ...
		 src4_data	:	OUT  STD_LOGIC_VECTOR (107 DOWNTO 0);
		 src4_endofpacket	:	OUT  STD_LOGIC;
		 src4_ready	:	IN  STD_LOGIC;
		 src4_startofpacket	:	OUT  STD_LOGIC;
		 src4_valid	:	OUT  STD_LOGIC
	 ); 
 END mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_mm_interconnect_0_cmd_demux_003;

 ARCHITECTURE RTL OF mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_mm_interconnect_0_cmd_demux_003 IS
	 ...
	 SIGNAL  s_wire_mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_mm_interconnect_0_cmd_demux_003_wideor0_11_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_mm_interconnect_0_cmd_demux_003_wideor0_11_dataout <= ((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0));
	sink_ready <= s_wire_mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_mm_interconnect_0_cmd_demux_003_wideor0_11_dataout;
	src0_channel <= ( "0" & "0" & "0" & "0" & "0" & sink_channel(7 DOWNTO 5));
	src0_data <= ( sink_data(107 DOWNTO 0));
	src0_endofpacket <= sink_endofpacket;
	src0_startofpacket <= sink_startofpacket;
	src0_valid <= (sink_valid(0) AND sink_channel(0));
	src1_channel <= ( "0" & "0" & "0" & "0" & "0" & sink_channel(7 DOWNTO 5));
	src1_data <= ( sink_data(107 DOWNTO 0));
	src1_endofpacket <= sink_endofpacket;
	src1_startofpacket <= sink_startofpacket;
	src1_valid <= (sink_valid(1) AND sink_channel(1));
	src2_channel <= ( "0" & "0" & "0" & "0" & "0" & sink_channel(7 DOWNTO 5));
	src2_data <= ( sink_data(107 DOWNTO 0));
	src2_endofpacket <= sink_endofpacket;
	src2_startofpacket <= sink_startofpacket;
	src2_valid <= (sink_valid(2) AND sink_channel(2));
	src3_channel <= ( "0" & "0" & "0" & "0" & "0" & sink_channel(7 DOWNTO 5));
	src3_data <= ( sink_data(107 DOWNTO 0));
	src3_endofpacket <= sink_endofpacket;
	src3_startofpacket <= sink_startofpacket;
	src3_valid <= (sink_valid(3) AND sink_channel(3));
	src4_channel <= ( "0" & "0" & "0" & "0" & "0" & sink_channel(7 DOWNTO 5));
	src4_data <= ( sink_data(107 DOWNTO 0));
 ...
 END RTL; --mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_mm_interconnect_0_cmd_demux_003
