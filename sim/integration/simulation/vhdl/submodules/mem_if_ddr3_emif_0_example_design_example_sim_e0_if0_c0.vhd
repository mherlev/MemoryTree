-- mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_c0.vhd
...
entity mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_c0 is
	port (
		...
		afi_seq_busy         : in  std_logic_vector(0 downto 0)   := (others => '0'); --             .afi_seq_busy
...
end entity mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_c0;

architecture rtl of mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_c0 is
	component alt_mem_if_nextgen_ddr3_controller_core is
		...
		port (
			...
			itf_cmd_address         : in  std_logic_vector(23 downto 0)  := (others => 'X'); -- itf_cmd_address
			itf_cmd_burstlen        : in  std_logic                      := 'X';             -- itf_cmd_burstlen
			...
			itf_wr_data             : in  std_logic_vector(511 downto 0) := (others => 'X'); -- itf_wr_data
			itf_wr_data_byte_en     : in  std_logic_vector(63 downto 0)  := (others => 'X'); -- itf_wr_data_byte_en
			...
			itf_rd_data             : out std_logic_vector(511 downto 0);                    -- itf_rd_data
	...
	component alt_mem_ddrx_mm_st_converter is
		...
		port (
			...
			itf_cmd_address       : out std_logic_vector(23 downto 0);                     -- itf_cmd_address
			itf_cmd_burstlen      : out std_logic;                                         -- itf_cmd_burstlen
			...
			itf_wr_data           : out std_logic_vector(511 downto 0);                    -- itf_wr_data
			itf_wr_data_byte_en   : out std_logic_vector(63 downto 0);                     -- itf_wr_data_byte_en
			...
			itf_rd_data           : in  std_logic_vector(511 downto 0) := (others => 'X'); -- itf_rd_data
	...
	signal a0_native_st_itf_wr_data           : std_logic_vector(511 downto 0); -- a0:itf_wr_data -> ng0:itf_wr_data
	...
	signal a0_native_st_itf_wr_data_byte_en   : std_logic_vector(63 downto 0);  -- a0:itf_wr_data_byte_en -> ng0:itf_wr_data_byte_en
	signal a0_native_st_itf_cmd_address       : std_logic_vector(23 downto 0);  -- a0:itf_cmd_address -> ng0:itf_cmd_address
	...
	signal ng0_native_st_itf_rd_data          : std_logic_vector(511 downto 0); -- ng0:itf_rd_data -> a0:itf_rd_data
	signal a0_native_st_itf_cmd_burstlen      : std_logic;                      -- a0:itf_cmd_burstlen -> ng0:itf_cmd_burstlen
...
end architecture rtl; -- of mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_c0
