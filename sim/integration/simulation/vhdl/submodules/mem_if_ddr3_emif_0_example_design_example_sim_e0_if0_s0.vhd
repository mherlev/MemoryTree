-- mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0.vhd

-- This file was auto-generated from qsys_sequencer_110_hw.tcl.  If you edit it your changes
-- will probably be lost.
-- 
-- Generated using ACDS version 14.0 200 at 2016.05.21.21:51:47

library IEEE;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;

entity mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0 is
	port (
		...
		phy_read_fifo_q             : in  std_logic_vector(511 downto 0) := (others => '0'); --                 .phy_read_fifo_q
		...
		afi_addr                    : out std_logic_vector(55 downto 0);                     --              afi.afi_addr
		...
		afi_rdata                   : in  std_logic_vector(511 downto 0) := (others => '0'); --                 .afi_rdata
		afi_rdata_valid             : in  std_logic_vector(3 downto 0)   := (others => '0'); --                 .afi_rdata_valid
		scc_data                    : out std_logic_vector(7 downto 0);                      --              scc.scc_data
		...
		capture_strobe_tracking     : in  std_logic_vector(7 downto 0)   := (others => '0'); --                 .capture_strobe_tracking
		...
		seq_waitrequest             : out std_logic;                                         --        seq_debug.waitrequest
		seq_readdata                : out std_logic_vector(31 downto 0);                     --                 .readdata
		seq_readdatavalid           : out std_logic;                                         --                 .readdatavalid
		seq_burstcount              : in  std_logic_vector(0 downto 0)   := (others => '0'); --                 .burstcount
		seq_writedata               : in  std_logic_vector(31 downto 0)  := (others => '0'); --                 .writedata
		seq_address                 : in  std_logic_vector(31 downto 0)  := (others => '0'); --                 .address
		seq_write                   : in  std_logic                      := '0';             --                 .write
		seq_read                    : in  std_logic                      := '0';             --                 .read
		seq_byteenable              : in  std_logic_vector(3 downto 0)   := (others => '0'); --                 .byteenable
		seq_debugaccess             : in  std_logic                      := '0'              --                 .debugaccess
	);
end entity mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0;

architecture rtl of mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0 is
	...
	component altera_mem_if_sequencer_cpu_no_ifdef_params_sim_cpu_inst is
		generic (
	...
	end component altera_mem_if_sequencer_cpu_no_ifdef_params_sim_cpu_inst;
	...
	component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_trk_mm_bridge is
		port (
			clk              : in  std_logic                     := 'X';             -- clk
	...
	end component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_trk_mm_bridge;
	...
	component sequencer_data_mgr is
		generic (
			AVL_DATA_WIDTH                    : integer := 32;
			AVL_ADDR_WIDTH                    : integer := 13;
			MAX_LATENCY_COUNT_WIDTH           : integer := 5;
			...
			AFI_DEBUG_INFO_WIDTH              : integer := 32;
			AFI_MAX_WRITE_LATENCY_COUNT_WIDTH : integer := 32;
			AFI_MAX_READ_LATENCY_COUNT_WIDTH  : integer := 5;
			CALIB_VFIFO_OFFSET                : integer := 14;
			CALIB_LFIFO_OFFSET                : integer := 5;
	...
	end component sequencer_data_mgr;
	...
	component rw_manager_ddr3 is
		...
		port (
			...
			afi_rrank         : out std_logic_vector(31 downto 0);                     -- afi_rrank
			afi_wrank         : out std_logic_vector(31 downto 0)                      -- afi_wrank
		);
	...
	component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_seq_bridge is
		port (
			clk              : in  std_logic                     := 'X';             -- clk
			reset            : in  std_logic                     := 'X';             -- reset
			s0_waitrequest   : out std_logic;                                        -- waitrequest
	...
	end component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_seq_bridge;

	component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_mm_interconnect_0 is
		port (
			...
			seq_bridge_m0_burstcount                                     : in  std_logic_vector(0 downto 0)  := (others => 'X'); -- burstcount
			...
			seq_bridge_m0_debugaccess                                    : in  std_logic                     := 'X';             -- debugaccess
			...
			sequencer_data_mgr_inst_avl_address                          : out std_logic_vector(12 downto 0);                    -- address
			sequencer_data_mgr_inst_avl_write                            : out std_logic;                                        -- write
			sequencer_data_mgr_inst_avl_read                             : out std_logic;                                        -- read
			sequencer_data_mgr_inst_avl_readdata                         : in  std_logic_vector(31 downto 0) := (others => 'X'); -- readdata
			sequencer_data_mgr_inst_avl_writedata                        : out std_logic_vector(31 downto 0);                    -- writedata
			sequencer_data_mgr_inst_avl_waitrequest                      : in  std_logic                     := 'X';             -- waitrequest
	...
	end component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_mm_interconnect_0;

	component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_irq_mapper is
		port (
			clk        : in  std_logic                     := 'X'; -- clk
			reset      : in  std_logic                     := 'X'; -- reset
			sender_irq : out std_logic_vector(31 downto 0)         -- irq
		);
	end component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_irq_mapper;

	signal sequencer_rst_reset_out_reset                             : std_logic;                     -- sequencer_rst:reset_out -> [irq_mapper:reset, mm_interconnect_0:cpu_inst_reset_n_reset_bridge_in_reset_reset, mm_interconnect_0:sequencer_trk_mgr_inst_avl_reset_reset_bridge_in_reset_reset, seq_bridge:reset, sequencer_mem:reset1, sequencer_rst_reset_out_reset:in, trk_mm_bridge:reset]
	...
	signal seq_bridge_m0_burstcount                                  : std_logic_vector(0 downto 0);  -- seq_bridge:m0_burstcount -> mm_interconnect_0:seq_bridge_m0_burstcount
	signal seq_bridge_m0_waitrequest                                 : std_logic;                     -- mm_interconnect_0:seq_bridge_m0_waitrequest -> seq_bridge:m0_waitrequest
	signal seq_bridge_m0_address                                     : std_logic_vector(31 downto 0); -- seq_bridge:m0_address -> mm_interconnect_0:seq_bridge_m0_address
	signal seq_bridge_m0_writedata                                   : std_logic_vector(31 downto 0); -- seq_bridge:m0_writedata -> mm_interconnect_0:seq_bridge_m0_writedata
	signal seq_bridge_m0_write                                       : std_logic;                     -- seq_bridge:m0_write -> mm_interconnect_0:seq_bridge_m0_write
	signal seq_bridge_m0_read                                        : std_logic;                     -- seq_bridge:m0_read -> mm_interconnect_0:seq_bridge_m0_read
	signal seq_bridge_m0_readdata                                    : std_logic_vector(31 downto 0); -- mm_interconnect_0:seq_bridge_m0_readdata -> seq_bridge:m0_readdata
	signal seq_bridge_m0_debugaccess                                 : std_logic;                     -- seq_bridge:m0_debugaccess -> mm_interconnect_0:seq_bridge_m0_debugaccess
	signal seq_bridge_m0_byteenable                                  : std_logic_vector(3 downto 0);  -- seq_bridge:m0_byteenable -> mm_interconnect_0:seq_bridge_m0_byteenable
	signal seq_bridge_m0_readdatavalid                               : std_logic;                     -- mm_interconnect_0:seq_bridge_m0_readdatavalid -> seq_bridge:m0_readdatavalid
	signal trk_mm_bridge_m0_burstcount                               : std_logic_vector(0 downto 0);  -- trk_mm_bridge:m0_burstcount -> mm_interconnect_0:trk_mm_bridge_m0_burstcount
	signal trk_mm_bridge_m0_waitrequest                              : std_logic;                     -- mm_interconnect_0:trk_mm_bridge_m0_waitrequest -> trk_mm_bridge:m0_waitrequest
	signal trk_mm_bridge_m0_address                                  : std_logic_vector(15 downto 0); -- trk_mm_bridge:m0_address -> mm_interconnect_0:trk_mm_bridge_m0_address
	signal trk_mm_bridge_m0_writedata                                : std_logic_vector(31 downto 0); -- trk_mm_bridge:m0_writedata -> mm_interconnect_0:trk_mm_bridge_m0_writedata
	signal trk_mm_bridge_m0_write                                    : std_logic;                     -- trk_mm_bridge:m0_write -> mm_interconnect_0:trk_mm_bridge_m0_write
	signal trk_mm_bridge_m0_read                                     : std_logic;                     -- trk_mm_bridge:m0_read -> mm_interconnect_0:trk_mm_bridge_m0_read
	signal trk_mm_bridge_m0_readdata                                 : std_logic_vector(31 downto 0); -- mm_interconnect_0:trk_mm_bridge_m0_readdata -> trk_mm_bridge:m0_readdata
	signal trk_mm_bridge_m0_debugaccess                              : std_logic;                     -- trk_mm_bridge:m0_debugaccess -> mm_interconnect_0:trk_mm_bridge_m0_debugaccess
	signal trk_mm_bridge_m0_byteenable                               : std_logic_vector(3 downto 0);  -- trk_mm_bridge:m0_byteenable -> mm_interconnect_0:trk_mm_bridge_m0_byteenable
	signal trk_mm_bridge_m0_readdatavalid                            : std_logic;                     -- mm_interconnect_0:trk_mm_bridge_m0_readdatavalid -> trk_mm_bridge:m0_readdatavalid
	...
	signal mm_interconnect_0_sequencer_data_mgr_inst_avl_waitrequest : std_logic;                     -- sequencer_data_mgr_inst:avl_waitrequest -> mm_interconnect_0:sequencer_data_mgr_inst_avl_waitrequest
	signal mm_interconnect_0_sequencer_data_mgr_inst_avl_writedata   : std_logic_vector(31 downto 0); -- mm_interconnect_0:sequencer_data_mgr_inst_avl_writedata -> sequencer_data_mgr_inst:avl_writedata
	signal mm_interconnect_0_sequencer_data_mgr_inst_avl_address     : std_logic_vector(12 downto 0); -- mm_interconnect_0:sequencer_data_mgr_inst_avl_address -> sequencer_data_mgr_inst:avl_address
	signal mm_interconnect_0_sequencer_data_mgr_inst_avl_write       : std_logic;                     -- mm_interconnect_0:sequencer_data_mgr_inst_avl_write -> sequencer_data_mgr_inst:avl_write
	signal mm_interconnect_0_sequencer_data_mgr_inst_avl_read        : std_logic;                     -- mm_interconnect_0:sequencer_data_mgr_inst_avl_read -> sequencer_data_mgr_inst:avl_read
	signal mm_interconnect_0_sequencer_data_mgr_inst_avl_readdata    : std_logic_vector(31 downto 0); -- sequencer_data_mgr_inst:avl_readdata -> mm_interconnect_0:sequencer_data_mgr_inst_avl_readdata
	...
	signal sequencer_rst_reset_out_reset_ports_inv                   : std_logic;                     -- sequencer_rst_reset_out_reset:inv -> [cpu_inst:reset_n, sequencer_data_mgr_inst:avl_reset_n, sequencer_phy_mgr_inst:avl_reset_n, sequencer_reg_file_inst:avl_reset_n, sequencer_rw_mgr_inst:avl_reset_n, sequencer_scc_mgr_inst:avl_reset_n, sequencer_trk_mgr_inst:avl_reset_n]
...
begin
	...
	cpu_inst : component altera_mem_if_sequencer_cpu_no_ifdef_params_sim_cpu_inst
		generic map (
	...
	trk_mm_bridge : component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_trk_mm_bridge
		port map (
			clk              => avl_clk,                                          --   clk.clk
	...
	sequencer_data_mgr_inst : component sequencer_data_mgr
		generic map (
			AVL_DATA_WIDTH                    => 32,
			AVL_ADDR_WIDTH                    => 13,
			MAX_LATENCY_COUNT_WIDTH           => 4,
	...
	sequencer_rw_mgr_inst : component rw_manager_ddr3
		generic map (
			...
			DEVICE_FAMILY                        => "STRATIXV",
			AC_ROM_INIT_FILE_NAME                => "mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_AC_ROM.hex",
			INST_ROM_INIT_FILE_NAME              => "mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_inst_ROM.hex",
	...
	sequencer_mem : component altera_mem_if_sequencer_mem_no_ifdef_params
		generic map (
			...
			AVL_SYMBOL_WIDTH => 8,
			MEM_SIZE         => 13312,
			INIT_FILE        => "mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_sequencer_mem.hex",
			RAM_BLOCK_TYPE   => "AUTO"
		)
		port map (
	...
	seq_bridge : component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_seq_bridge
		port map (
			clk              => avl_clk,                       --   clk.clk
			reset            => sequencer_rst_reset_out_reset, -- reset.reset
	...
	mm_interconnect_0 : component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_mm_interconnect_0
		port map (
	...
	irq_mapper : component mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0_irq_mapper
		port map (
			clk        => avl_clk,                       --       clk.clk
...
end architecture rtl; -- of mem_if_ddr3_emif_0_example_design_example_sim_e0_if0_s0
