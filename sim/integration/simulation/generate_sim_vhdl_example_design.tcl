if {[is_project_open]} {
	...
	if {[string compare $project_name "generate_sim_example_design"] != 0} {
		...
		post_message -type error "in the directory mem_if_ddr3_emif_0_example_design_example_design/simulation/"
		return 1
	}
}
set variant_name mem_if_ddr3_emif_0_example_design_example_sim
set arg_list [list]
