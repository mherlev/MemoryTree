...
add wave -label cmd sim:/root_2_root/root_module/cmd 
add wave -label cmd_next sim:/root_2_root/root_module/cmd_next 
add wave -label core_id sim:/root_2_root/root_module/core_id 
add wave -label core_id_next sim:/root_2_root/root_module/core_id_next 
#add wave -label core_id sim:/root_2_root/root_module/counter 
...
add wave -label l2r sim:/root_2_root/root_module/l2r 
add wave -label l2r_state sim:/root_2_root/root_module/l2r_state 
...
add wave -label r2l sim:/root_2_root/root_module/r2l 
add wave -label r2l_route sim:/root_2_root/root_module/r2l_route 
